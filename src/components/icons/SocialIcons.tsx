...
// Instagram Icon - Gradient with camera
...
// YouTube Icon - Play button in red
...
// TikTok Icon - Musical note with T shape
...
// WhatsApp Icon - Phone with circle
...
// Discord Icon - Gaming controller
...
// Snapchat Icon - use brand image from public assets
...
// Indeed Icon - official brand via Simple Icons CDN (vector)
export const IndeedIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <img
    src="https://cdn.simpleicons.org/indeed/ffffff"
    alt="Indeed"
    className={className}
    loading="lazy"
    decoding="async"
...
// Vinted Icon - official brand via Simple Icons CDN (vector)
export const VintedIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <img
    src="https://cdn.simpleicons.org/vinted/00BFA5"
    alt="Vinted"
    className={className}
    loading="lazy"
    decoding="async"
